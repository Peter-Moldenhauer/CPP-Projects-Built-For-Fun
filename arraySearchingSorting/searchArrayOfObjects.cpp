...
** Date: 11/8/16
** Description: This program demonstrates a linear search of an array of class objects. Linear and
** binary searches can be used to search for a specific entry in an array of objects. In this case,
** the search value is not the entire object but rather a value in a particular member variable of
** that object. The member variable being examined by the search is called the key field and the
** particular value being looked for is called the search key.
**
** Specifically, this program searches an array of Inventory objects to get the price of a particular
** object.
******************************************************************************************************/
...
** Description: This function performs a linear search on an
** array of Inventory objects, using itemCode as the key field.
** If the desired code is found, its array subscript is returned.
