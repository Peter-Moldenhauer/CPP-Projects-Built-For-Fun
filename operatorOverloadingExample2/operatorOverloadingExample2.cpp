...
* Date: 10/16/16
* Description: This program demonstrates the three different ways to overload operators.
* 1st way - use a completely unrelated function from teh class and main
* 2nd way - use the friend function in a class, can access variables directly
* 3rd way - overloads a member function in a class
*******************************************************************************************/
